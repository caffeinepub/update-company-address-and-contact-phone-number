...
import type { ExternalBlob as _ExternalBlob, Product as _Product, ProductCategory as _ProductCategory, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addIndustry(arg0: Industry): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getIndustries(): Promise<Array<Industry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getIndustries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "scrapShredders" in value ? ProductCategory.scrapShredders : "billetShearingMachines" in value ? ProductCategory.billetShearingMachines : "eotCranes" in value ? ProductCategory.eotCranes : value;
}
...
function to_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProductCategory): {
    ...
    return value == ProductCategory.scrapShredders ? {
        scrapShredders: null
    } : value == ProductCategory.billetShearingMachines ? {
        billetShearingMachines: null
    } : value == ProductCategory.eotCranes ? {
        eotCranes: null
    } : value;
}
